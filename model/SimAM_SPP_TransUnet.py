...
from model.ECA_Module import ECA_Module
from model.GAM_module import GAM_module
from model.SimAM_module import simam_module
...
class Encoder(nn.Module):
    def __init__(self, in_channels, out_channels=64):
        ...
        self.sim=simam_module(channels=out_channels * 16)
...
class SimAM_SPP_TransUnet(nn.Module):
