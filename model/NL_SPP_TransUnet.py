...
from model.Non_local import _NonLocalBlockND
from model.SE_Leaky_block import SE_Leaky_block
...
class Encoder(nn.Module):
    def __init__(self, in_channels, out_channels=64):
        ...
        self.nl=_NonLocalBlockND(out_channels * 16)
...
class NL_SPP_Leaky_TransUnet(nn.Module):
