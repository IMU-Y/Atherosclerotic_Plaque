...
class PlaqueNet_CBAM_IN(nn.Module):
    def __init__(self, in_channels=3, output_channels=2, bilinear=True):
        super(PlaqueNet_CBAM_IN, self).__init__()
        ...
        # 再解码层的双卷积之前加上CBAM
        self.up1 = CABM_Up(1024, 512 // factor, bilinear)
        self.up2 = CABM_Up(512, 256 // factor, bilinear)
        self.up3 = CABM_Up(256, 128 // factor, bilinear)
        self.up4 = CABM_Up(128, output_channels, bilinear)
