...
from model.fusionModel.SE_Leaky_block import SE_Leaky_block
# from model.SE_block import SE_block
from model.fusionModel.unet_parts import DoubleConv
from model.fusionModel.vit import ViT
...
class SPPLayer(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.num_levels):
            ...
            # conv and upsample
            tensor = F.leaky_relu(self.conv(tensor))
...
class Encoder(nn.Module):
    def __init__(self, in_channels, out_channels=64):
        ...
        self.se = SE_Leaky_block(out_channels * 16)
...
class SE_SPP_Leaky_TransUnet(nn.Module):
