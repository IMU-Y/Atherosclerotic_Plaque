...
class Encoder(nn.Module):
    def __init__(self, in_channels, out_channels=64):
        ...
        # 24*512
        self.encoder4 = EncoderBottleneck(out_channels * 8, out_channels * 16)
        self.encoder5 = EncoderBottleneck1(out_channels * 16, out_channels * 8)
