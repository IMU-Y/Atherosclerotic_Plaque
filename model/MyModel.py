...
class MyModel(nn.Module):
    def __init__(self, in_channels=3, output_channels=2, bilinear=True):
        ...
        # self.spp = SPPLayer(512 // factor, 3)
        # self.spp_double_conv = DoubleConv((512 // factor) * 4, 512 // factor)
        ...
        # self.spp = SPPLayer(256 // factor, 3)
        # self.spp_double_conv = DoubleConv((256 // factor) * 4, 256 // factor)
