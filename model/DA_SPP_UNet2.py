...
class Encoder(nn.Module):
    def __init__(self, in_channels, out_channels=64):
        ...
        # 192*64
        self.encoder1 = EncoderBottleneck1(64, out_channels * 2, stride=2)
        # 96*128
        self.encoder2 = EncoderBottleneck1(out_channels * 2, out_channels * 4, stride=2)
        # 48*256
        self.encoder3 = EncoderBottleneck1(out_channels * 4, out_channels * 8, stride=2)
        # 24*512
